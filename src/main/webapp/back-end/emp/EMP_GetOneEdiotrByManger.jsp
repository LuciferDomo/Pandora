                ...
                <div class="wrapper">
                    ...
                    <nav id="navbar-header" class="main-header navbar navbar-expand navbar-white navbar-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-widget="login-out"
                                    href="<%=request.getContextPath()%>/EmpLoginServlet?action=EMPSignOut"
                                    role="button">
                            ...
                            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                                <div class="image">
                                    <img src="<%=request.getContextPath()%>/EMPImageServlet?action=usesrImage"
                                        name="action" alt="User Image" />
                                </div>
                                <div class="info">
                                    <input name="Userlogin" type="hidden">
                                    <a href="#"
                                        class="d-block">${loginUser.englishFirstName}&nbsp${loginUser.englishLastName}</a>
                                    ...
                                    <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                            <li class="breadcrumb-item">
                                                <a
                                                    href="<%=request.getContextPath()%>/EmpLoginServlet?action=EMPAllList">
                                                    員工資料</a>
                                            </li>
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-5 col-md-6 col-sm-8">
                                                ...
                                                <form action="<%=request.getContextPath()%>/EmpLoginServlet"
                                                    ...
                                                    <div class="form-group">
                                                        <h1>
                                                            <input type="hidden" name="employeeId"
                                                                value="${empVOupdate.employeeId}">
                                                            員工編號:${empVOupdate.employeeId}
                                                        </h1>
                                                        <hr />
                                                    </div>
                                                    </br>
                                                    <center>
                                                        ...
                                                        <div class="col-sm-6" style="text-align:center">
                                                            ...
                                                            <div id="preview" class="preview" style="text-align:center">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-6" id="showOldImage">
                                                <img src="<%=request.getContextPath()%>/EMPImageServlet?action=empVOUpdate&employeeId=${empVOupdate.employeeId}"
                                                    name="action" alt="User Image" style=width:100% />
                                            </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly class="date-pick form-control" type="date"
                                                            name="empBirthday" value="${empVOupdate.empBirthday}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="empCellphoneNo" class="form-control"
                                                            value="${empVOupdate.empCellphoneNo}" />
                                                        <font class="text-danger">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="radio" name="gender"
                                                            value="${empVOupdate.gender}" id="sexOption"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="empAddress"
                                                    value="${empVOupdate.empAddress}" placeholder="居住地址" />
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>雇用日期</label>
                                                        <input readonly class="date-pick form-control" type="date"
                                                            name="startDate" value="${empVOupdate.startDate}"
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-sm-12" style="text-align:right">
                                                    <div class="form-group">
                                                        <button class="btn btn-primary" name="action" value="EMPUpdate"
                                                            type="submit">確認修改</button>
                                                    </div>
                                                </div>
                                            </div>
                                            </form>

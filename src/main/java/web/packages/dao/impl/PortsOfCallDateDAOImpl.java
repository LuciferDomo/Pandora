...
public class PortsOfCallDateDAOImpl implements PortsOfCallDateDAO {
	...
	public void insertPortsOfCallDate(PortsOfCallDateVO portsOfCallDateVO) {
		...
		try {
			...
			if(portsOfCallDateVO.getDepartureTime()!=null && !"".equals(portsOfCallDateVO.getDepartureTime().toString().trim())) {
			...
			if(portsOfCallDateVO.getArrivalTime()!=null && !"".equals(portsOfCallDateVO.getArrivalTime().toString().trim())) {

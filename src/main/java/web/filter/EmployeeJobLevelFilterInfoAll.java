...
@WebFilter(urlPatterns = {"/back-end/emp/EMP_InfoAll.jsp"})
public class EmployeeJobLevelFilterInfoAll implements Filter {
...
//		}
		...
		if (user != null) {
			...
			if (!"Manger".equals(jobLevel)) {
				res.sendRedirect(req.getContextPath() + "/back-end/emp/EMP_LowJobLevel_InfoAll.jsp");
				return;
			}
